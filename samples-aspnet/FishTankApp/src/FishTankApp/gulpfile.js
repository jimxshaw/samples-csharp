...
// The browser can only recognize files in the wwwroot folder.
var paths = {
    webroot: "./wwwroot/"
};
...
// We don't want the above tasks to run individually. So we create a couple of new tasks that
// contains the above 5 tasks.
